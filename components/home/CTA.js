    ...
    return (
        ...
        <div className={"w-full m-auto pt-16"}>
            ...
            <div className={"w-[90%] m-auto xl:w-[85%]"}>
                {/*<div className={"relative z-[1] m-auto bg-[#161A1D] rounded-[16px]"}>*/}
             {/*   <div className={"relative z-[1] m-auto bg-[#161A1D] rounded-[16px] bg-[url('https://placekitten.com/1400')] bg-cover"}>

                    <img className={"absolute z-[1] rounded-[8px] w-full h-full object-cover absolute z-[1] top-0 left-0 h-full"} src="https://images.unsplash.com/photo-1652109348316-2ec63fa43632?auto=format&fit=crop&q=60&w=900&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MjZ8fDRrJTIwaGQlMjBpbWFnZXxlbnwwfHwwfHx8MA%3D%3D" alt=""/>
