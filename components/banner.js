            ...
            <div className="fixed z-10 inset-x-0 bottom-0 pb-2 sm:pb-5 bg-transparent">
                ...
                <div className="rounded-lg bg-white p-2 shadow-lg sm:p-3">
                    ...
                    <div className="order-3 mt-2 w-full flex-shrink-0 sm:order-2 sm:mt-0 sm:w-auto">
                        <a
                        href="/hiring-fair"
                        className="flex items-center justify-center rounded-md border border-transparent bg-vm-blue px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-vm-accent hover:text-vm-blue"
                        >
                        Register Now
                        </a>
                    </div>
