        ...
        <div className="relative z-10 pb-8 sm:pb-16 md:pb-20 lg:w-full lg:max-w-2xl lg:pb-28 xl:pb-32">
          <main className="mx-auto mt-10 max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
            <div className="sm:text-center lg:text-left">
              <h1 className="text-4xl font-bold tracking-tight text-white text-center sm:text-5xl md:text-left md:text-6xl">
                {props.content.hiringFairHero.fields.title}
              </h1>
              <p className="mt-3 text-base text-center text-white sm:mx-auto sm:mt-5 sm:max-w-xl sm:text-lg md:text-left md:mt-5 md:text-xl lg:mx-0">
