...
let Hero = ({title, subtitle, buttons, imageURL, videoURL, content, rowDirection = true}) => {
    ...
    let Background = ()=>{
        ...
        return (
            ...
            <div
                className={`z-[10] absolute top-0 left-0 w-full h-full bg-gradient-to-t from-white to-white opacity-[15%]`}></div>
                ...
                <div
                    ...
                    <div className={`w-full h-full mx-auto flex flex-col justify-between items-between`}>
                        <h1 className={`${(imageURL || videoURL || content) && 'md:pt-28 z-[2] md:absolute top-0 left-0'} md:w-[80%] w-full leading-[-0.01em] text-[47px] md:text-[55px] md:leading-[-3.2px] lg:text-[73px] lg:leading-[100%] mb-3 font-spline font-extrabold`}
                            ...
                            style={{WebkitTextStroke: `2px ${styles && `${styles.textColor.hexColor}` }`, color: "transparent"}}>
                            {title}
                        </h1>
