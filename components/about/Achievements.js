        ...
        <div className={"w-full m-auto pt-16"}>
            ...
            <div className={"w-[95%] m-auto xl:w-[85%]"}>
                <div className={"max-w-[80%] mx-auto w-[80%] m-auto text-center"}>
                    <h1 className="text-[26px] lg:text-[48px] md:text-[38px] font-bold text-darkGray mb-3">
            ...
            <div className={"lg:w-[70%] mx-auto mt-10 grid grid-cols-1 lg:grid-cols-2 mx-auto gap-y-4 gap-x-4 px-4 lg:px-0"}>
