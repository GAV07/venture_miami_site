export default function CTA() {
    return (
/*        <>
            <div className="py-24 flex min-h-full flex-1">
                    ...
                    <div className="mx-auto w-full max-w-sm lg:w-96">
                        <div>
                            ...
                            <h2 className="mt-8 text-2xl font-bold leading-9 tracking-tight text-gray-900">
                                Ready to Start a Business Venture or Become a part of the in Miami?
                            </h2>
        ...
        <div className="py-24 sm:py-32 w-screen h-max">
            <div className="mx-auto max-w-7xl px-6 lg:px-8 w-full h-full">
                <div className="mx-auto max-w-2xl lg:max-w-none w-full h-full flex flex-col justify-start items-start gap-y-4">
