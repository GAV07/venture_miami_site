        ...
        <div className="py-16">
          ...
          <nav className="mt-10 text-sm" aria-label="quick links">
            <ul className="-my-1 flex flex-wrap gap-4 md:flex-nowrap px-3 md:px-0 md:justify-center md:space-x-6">
              <li>
                <Link className="rounded-lg px-2 py-1 text-white hover:bg-white hover:text-vm-blue" href="/">
                  Home
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link className="rounded-lg px-2 py-1 text-white hover:bg-white hover:text-vm-blue" href="/partnerships">
                    Partnerships
                </Link>
              </li>
              <li>
          ...
          <div className="flex space-x-6">
            {props.socials.links.map((icon) => {
              if(icon.fields.text === "Twitter") {
                return(
                  <Link className="group" key={icon.fields.text} href={icon.fields.url}>
